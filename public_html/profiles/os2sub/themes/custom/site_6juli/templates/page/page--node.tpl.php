...
$social_share_title = $node->title;
$social_share_url   = url(drupal_get_path_alias('node/' . $node->nid),
  ['absolute' => TRUE]);
          ...
          <div class="views-field views-field-field-image-event">
            <div class="field-content">
              <div class="img-container"
                   style="background-image:url(<?php print image_style_url('6_juli_banner',
        ...
        <div class="background-slideshow row">
          <div class="views-field views-field-field-image-event">
            <div class="field-content">
              <div class="img-container"
                   style="background-image:url(<?php print image_style_url('6_juli_banner',
                     $node->field_os2web_base_field_lead_img['da'][0]['uri']); ?>);">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="background-slideshow row">
          <div class="views-field views-field-field-image-event">
            <div class="field-content">
              <div class="img-container"
                   style="background-image:url(<?php print image_style_url('6_juli_banner',
                     $node->field_image_event['und'][0]['uri']); ?>);">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="background-slideshow row">
          <div class="views-field views-field-field-image-event">
            <div class="field-content">
              <div class="img-container"
                   style="background-image:url(<?php print image_style_url('6_juli_banner',
                     $node->field_os2web_base_field_photo['und'][0]['uri']); ?>);">
              </div>
            </div>
          </div>
        </div>
