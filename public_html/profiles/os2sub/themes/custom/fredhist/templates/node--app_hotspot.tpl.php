...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div id="hotspot-container">
    <?php print render($content['field_app_hotspot_image']); ?>
    <?php foreach($hotspots as $hotspot): ?>
      <div class="hotspot-tooltip" style="left:<?php print $hotspot['x']; ?>%; top:<?php print $hotspot['y']; ?>%">
        <span class="icon"></span>
        <span class="text"><?php print $hotspot['text']; ?><span class="arrow"></span></span>
      </div>
    <?php endforeach; ?>
  </div>
