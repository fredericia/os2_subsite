...
function adapt_theme() {
  ...
  $items['block'] = array(
    ...
    'template' => 'object',
    'path' => drupal_get_path('theme', 'adapt') .'/templates',
  );
  $items['comment'] = array(
 ...
 */
function adapt_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'adapt';
}

/**
 * Implementation of preprocess_page().
 */
function adapt_preprocess_page(&$vars) {
 ...
 */
function adapt_preprocess_block(&$vars) {
  $vars['hook'] = 'block';
 ...
 */
function adapt_preprocess_node(&$vars) {
  $vars['hook'] = 'node';
 ...
 */
function adapt_preprocess_comment(&$vars) {
  $vars['hook'] = 'comment';
 ...
 */
function adapt_preprocess_fieldset(&$vars) {
 ...
 */
function adapt_preprocess_field(&$vars) {
 ...
 */
function adapt_textarea($variables) {
 ...
 */
function adapt_pager_list($vars) {
  $tags = $vars['tags'];
  $element = $vars['element'];
  $parameters = $vars['parameters'];
  $quantity = $vars['quantity'];
 ...
 */
function adapt_pager_link($vars) {
  $text = $vars['text'];
 ...
 */
function adapt_views_mini_pager($vars) {
  $tags = $vars['tags'];
  $quantity = $vars['quantity'];
  $element = $vars['element'];
  $parameters = $vars['parameters'];
...
function adapt_panels_default_style_render_region($vars) {
  $output = '';
